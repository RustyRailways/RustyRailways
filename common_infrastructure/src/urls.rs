...
pub const URL_S2: &str = "http://192.168.0.108/";
pub const URL_S3: &str = "http://192.168.0.106/";
pub const URL_S4: &str = "http://192.168.0.107/";
pub const URL_S5: &str = "http://192.168.0.105/";
pub const URL_S6: &str = "http://192.168.0.104/";
